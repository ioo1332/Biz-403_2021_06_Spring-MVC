...
public class GalleryController {
	...
	public String list(
	 ...
	 @RequestParam(value="search_column",required = false,defaultValue = "NONE")String search_text,
	 Model model) throws Exception {
		...
		//List<GalleryDTO> galleryPageList = gaService.selectAllPage(intPageNum,model);
