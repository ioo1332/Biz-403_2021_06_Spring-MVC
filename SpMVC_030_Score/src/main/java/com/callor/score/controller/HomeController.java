...
public class HomeController {
	...
	/*
	 * @ResponseBody API Server를 만들때 String type 의 데이터를 Response하라는 지시어
	 * 
	 * API Server 
	 * 서로다른 서버와 서버사이, 서버와 클라이언트 간에 조건을 request하고 그 결과를 data로 Response하는 서비스
	 * 
	 * 서로 다른 프로젝트로 서버와 클라이언트를 개발한다 API Service는 주고받은 데이터를 XML type, JSON type으로 만든다
	 */
	@ResponseBody
