...
public class BookController {
	...
	/*
	 * 통상적인 springFramework의 method에서는 view 파일의 이름을 String 형으로 return 하고
	 * view 에서 랜더링할 데이터는 model객체에 담아서 Attribute로 담아서 보내는 방식이다
	 * 
	 * ModelAndView객체를 생성하여
	 * view는 setViewName method를 이용하여 setting하고
	 * 랜더링할 데이터는 addObject method 이용하여 추가하고
	 * ModelAndView객체를 return하는 방식도 사용한다
	 */
